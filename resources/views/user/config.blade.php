                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}" enctype="multipart/form-data" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <!--Mostrar avatar actual (si es que tiene uno)-->
                                @if(Auth::user()->image != null)
                                    <!--Avatar-->
                                    @include('includes.avatar')
                                @else
                                    <span>No tienes Avatar pero puedes agregar uno</span>
                                @endif

                                <input id="image" type="file" class="form-control @error('image') @enderror" name="image">
